...
class NetworkModel:
    def __init__(self):
        self.id_to_network_arrows_map = dict()
        self.arrows_into_id_map = dict()
        self.arrows_out_of_id_map = dict()
...
class NetworkPath:
    def __init__(self, path=None, lower_weight=1, upper_weight=1):
...
def travel_backwards(active_paths, inactive_paths):
    while active_paths:
        ...
        inactive_paths = new_inactive_paths
